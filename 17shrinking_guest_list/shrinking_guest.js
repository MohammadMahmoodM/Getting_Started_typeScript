...
while (guestList.length > 2) {
    ...
    console.log("we\u2019re sorry ".concat(removed_guest, " we can\u2019t invite you to dinner"));
}
console.log("Dear ".concat(guestList, ", After guest Modification we decided your still invited"));
// now remove remaining two guest also
while (guestList.length > 0) {
    var empty_guest_list = guestList.pop();
}
console.log("Checking either our list is empty or not \"".concat(guestList, "\" if no name between \"\" hence prove its empty"));
